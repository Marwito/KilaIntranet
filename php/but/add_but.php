		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					<h2><b>BUT</b></h2>
					<p>einen neuen Bescheid hinzufügen</p>
				</div>
			</div>
		</div>
	</div>
                      ...
                      <div class="col-xs-12">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input class="form-control" id="aktenzeichen" name="aktenzeichen" required/>
                          </div>
                        </div>
                        <div class="col-md-12">
                      ...
                      <div class="col-xs-12">
                        <div class="col-md-12">
                          ...
                          <div class="form-group custom-font">
							...
							<input style="font-family:verdana;font-size:16px" type="text" class="form-control" data-toggle="datetimepicker" data-target="#datetimepicker_bescheid_von" name="datetimepicker_bescheid_von" id="datetimepicker_bescheid_von" required>
                          </div>
                          <div class="form-group custom-font">
                            <label class="control-label">Bescheid bis</label>
							<input style="font-family:verdana;font-size:16px" type="text" class="form-control" data-toggle="datetimepicker" data-target="#datetimepicker_bescheid_bis" name="datetimepicker_bescheid_bis" id="datetimepicker_bescheid_bis" required>                            
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12" style="padding-bottom:10px;">
    			  	    	...
    			  	    	<div class="form-group" style="padding-bottom:-5px;">
                                <select class="form-control" id="anteilsart" name="anteilsart" required>
                                  <option value=""/>
                                  <option value="1">pro Essen</option>
                    ...
                    <fieldset id="but_step-6" class="">
                      <div class="col-xs-12">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            <input class="form-control" id="anteilsbetrag" name="anteilsbetrag" required/>
                          </div>            
                        </div>
                        <div class="col-md-12">
                    ...
                    <fieldset id="but_step-7" class="">
                      <div class="col-xs-12">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            <input class="form-control" id="debitorennummer" name="debitorennummer" required/>
                          </div>            
                        </div>
                        <div class="col-md-12">
...
<script src="../../../js/but/add_but.js"></script>
