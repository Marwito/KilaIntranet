		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>Ein neues Rezept hinzufügen</p>
				</div>
			</div>
		</div>
	</div>
        	...
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
    			  	...
    			  	<div class="form-group">
		    			...
		    			<div class="invalid-feedback"> Bitte wählen Sie eine Zutat aus! </div>
    			  	</div>
    			  	<div class="form-group">
...
<script src="../../../../js/kuechenbereich/essen/rezept/add_rezept.js"></script>
