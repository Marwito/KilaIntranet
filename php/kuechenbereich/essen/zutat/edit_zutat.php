...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT * FROM keis2_zutat WHERE id =
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="zutat" name="zutat" value="<?php echo $row['id']; ?>">
...
<script>var einheitId = "<?php echo $row['einheit'];?>";</script>
<script src="../../../../js/kuechenbereich/essen/zutat/edit_zutat.js"></script>
