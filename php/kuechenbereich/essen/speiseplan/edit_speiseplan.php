...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT * FROM keis2_speiseplan WHERE id =
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>einen Speiseplan bearbeiten</p>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="speiseplan" name="speiseplan" value="<?php echo $row['id']; ?>">
    				<div class="form-group">
    				    <label for="input_text0">Datum</label>
    				    <input type="text" class="form-control" name="input_text0" id="input_text0" required value ="<?php echo $row['datum']?>">
    				    <div class="invalid-feedback"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_text1">Hauptgericht</label>
    				    <input type="text" class="form-control" name="input_text1" id="input_text1" required value ="<?php echo $row['hauptgericht']?>">
    				    <div class="invalid-feedback"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_text2">Beilage</label>
    				    <input type="text" class="form-control" name="input_text2" id="input_text2" required value ="<?php echo $row['beilage']?>">
    				    <div class="invalid-feedback"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_text3">Nachspeise</label>
    				    <input type="text" class="form-control" name="input_text3" id="input_text3" required value ="<?php echo $row['nachspeise']?>">
    				    <div class="invalid-feedback"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_select0">Einrichtung</label>
    			  	...
    			  	<div class="text-right my-5">							  	
    				  	<a href="../essen_list.php" class="btn btn-primary btn-custom">Zurück</a>
...
<script>var einrichtungId = "<?php echo $row['einrichtung'];?>";</script>
<script src="../../../../js/kuechenbereich/essen/speiseplan/edit_speiseplan.js"></script>
