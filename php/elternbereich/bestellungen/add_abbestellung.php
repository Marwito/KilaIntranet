...
if(isset($_POST['id'], $_POST['datum'], $_POST['frist'], $_POST['grund'], $_POST['essenkategorie'])){
    ...
    if(!$connector->isFeiertagInLand($_POST['datum'], LPLib_Feiertage_Connector::LAND_BAYERN)) {
        ...
        if($resultDauerbestellung->num_rows > 0) {
            if(strtotime("now") < $_POST['frist']) {
                $sql = "INSERT INTO keis2_abbestellung (kind, datum, grund, essenkategorie, insert_date)
