...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_ansprechpartner WHERE id = ".$conn->real_escape_string($_GET['id'])."";
        		...
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
    				...
    				<div class="form-group">
    			  	...
    			  	<div class="form-group">
    				    ...
    				    <input type="text" class="form-control" name="input_text5" id="input_text5" value="<?php echo $row['fax']; ?>">
    				    <div class="invalid-feedback"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
...
<script src="../../../js/administration/ansprechpartner/edit_ansprechpartner.js"></script>
