		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>eine neue Preiskategorie hinzufügen</p>
				</div>
			</div>
		</div>
	</div>
        	...
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
            		<div class="form-group">
    				    <label for="input_select0">Gastkategorie</label>
    				    <select class="form-control" name="input_select0" id="input_select0" required>
    				    	<option value="" selected>Wählen ...</option>
    				    	<option value="Kinder">Kinder</option>
    				    	<option value="Mitarbeiter">Mitarbeiter</option>
    				    </select>
    				    <div class="invalid-feedback"> Bitte wählen Sie eine Gast-kategorie aus! </div>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_select1">Essenkategorie</label>
    				    <select class="form-control" name="input_select1" id="input_select1" required>
    				    	<option value="" selected>Wählen ...</option>
    				    </select>
    				    <div class="invalid-feedback"> Bitte wählen Sie eine Essen-kategorie aus! </div>
    			  	</div>
    				<div class="form-group">
    				    <label for="input_text0">Preis (€)</label>
...
<script src="../../../js/administration/preiskategorie/add_preiskategorie.js"></script>
