...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_preiskategorie WHERE id =
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>eine Preiskategorie bearbeiten</p>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="preiskategorie" name="preiskategorie" value="<?php echo $row['id']; ?>">
    				<div class="form-group">
    				    <label for="input_text0">Gastkategorie</label>
    				    <input type="text" class="form-control" name="input_text0" id="input_text0" value="<?php echo $row['gastkategorie']; ?>" disabled>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_text1">Essenkategorie</label>
    				    <input type="text" class="form-control" name="input_text1" id="input_text1" value="<?php echo $customFunction->getNameEssenkategorie($row['essenkategorie']); $database->closeConnection();?>" disabled>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_text2">Preis (€)</label>
    				    <input type="text" class="form-control" name="input_text2" id="input_text2" required value="<?php echo $row['preis']; ?>">
    				...
    				<div class="mt-3 mb-2">
    			  	...
    			  	<div class="row">
    					<div id="div_gruppen" class="col-sm-12 table-responsive"></div>
    				</div>
                    <div class="text-right my-5">							  	
    				  	<a href="../einstellungen.php#preiskategorie" class="btn btn-primary btn-custom">Zurück</a>
...
<script src="../../../js/administration/preiskategorie/edit_preiskategorie.js"></script>
