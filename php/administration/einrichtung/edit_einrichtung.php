...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_einrichtung WHERE id =
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>eine Einrichtung bearbeiten</p>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="einrichtung" name="einrichtung" value="<?php echo $row['id']; ?>">
    				<div class="form-group">
    			  	...
    			  	<label for="input_text4">Abmeldefrist</label>
    			  	<div class="form-group custom-font">
    				    <input style="font-family:verdana;font-size:16px" type="text" class="form-control" data-toggle="datetimepicker" data-target="#datetimepicker1" name="input_text4" id="datetimepicker1" required value="<?php echo DateTime::createFromFormat('H:i:s', $row['abmeldefrist'])->format('H:i'); ?>">
    				    <div class="invalid-feedback" style="font-family:verdana"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
    				    <label for="input_text5">Vortag</label>
						<input type="range" class="custom-range" min="0" max="2" id="input_text5" name="input_text5" value="<?php echo $row['vortag']; ?>">
						<span class="small-size">Wert: <span id="value" class="small-size"></span></span>
    			  	</div>
    			  	<div class="mt-3 mb-2">
                    ...
                    <div class="text-right my-5">							  	
    				  	<a href="../einstellungen.php#einrichtung" class="btn btn-primary btn-custom">Zurück</a>
...
<script src="../../../js/administration/einrichtung/edit_einrichtung.js"></script>
