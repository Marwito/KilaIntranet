		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>eine neue Einrichtung hinzufügen</p>
				</div>
			</div>
		</div>
	</div>
        		...
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
    				<div class="form-group">
    			  	...
    			  	<div class="form-group custom-font">
    				    <input style="font-family:verdana;font-size:16px" type="text" class="form-control" data-toggle="datetimepicker" data-target="#datetimepicker1" name="input_text4" id="datetimepicker1" required>
    			  	...
    			  	<div class="form-group">
						...
						<input type="range" class="custom-range" min="0" max="2" id="input_text5" name="input_text5" value="0">
...
<script src="../../../js/administration/einrichtung/add_einrichtung.js"></script>
