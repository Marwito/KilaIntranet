...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_aktionsgruppe WHERE id =
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>Eine Aktionsgruppe bearbeiten</p>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="aktionsgruppe" name="aktionsgruppe" value="<?php echo $row['id']; ?>">
    			  	<div class="form-group">
    				    <label for="input_text1">Name</label>
    				    <input type="text" class="form-control" name="input_text1" id="input_text1" required value="<?php echo $row['bezeichnung']; ?>">
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.10.18/r-2.2.2/datatables.min.js"></script>
<script src="../../../js/administration/aktionsgruppe/edit_aktionsgruppe.js"></script>
