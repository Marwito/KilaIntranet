...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_POST['amt'])){
            ...
            $sql = "SELECT keis2_einrichtung.id, keis2_einrichtung.name, keis2_einrichtung.strasse, keis2_einrichtung.plz, keis2_einrichtung.ort FROM keis2_einrichtung, keis2_einrichtung_amt 
            WHERE keis2_einrichtung.id = keis2_einrichtung_amt.einrichtung_id
            and keis2_einrichtung_amt.amt_id = '".$conn->real_escape_string($_POST['amt'])."'";
