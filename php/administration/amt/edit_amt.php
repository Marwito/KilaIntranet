...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_amt WHERE id =
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="amt" name="amt" value="<?php echo $row['id']; ?>">
...
<script>var amt = "<?php echo $row['id'];?>";</script>
<script src="../../../js/administration/amt/edit_amt.js"></script>
