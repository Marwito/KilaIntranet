...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_gruppe WHERE id =
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="gruppe" name="gruppe" value="<?php echo $row['id']; ?>">
                    ...
                    <div class="text-right my-5">							  	
    				  	<a href="../einstellungen.php#gruppe" class="btn btn-primary btn-custom">Zurück</a>
...
<script src="../../../js/administration/gruppe/edit_gruppe.js"></script>
