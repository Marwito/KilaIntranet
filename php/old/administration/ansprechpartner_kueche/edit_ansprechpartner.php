...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(isset($_GET['id'])){
            ...
            $sql = "SELECT * FROM keis2_ansprechpartner_kueche WHERE id =
        		...
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
    				...
    				<div class="form-group">
    			  	...
    			  	<div class="form-group">
    				    ...
    				    <input type="text" class="form-control" name="input_text2" id="input_text2" required value="<?php echo $row['telefon']; ?>">
    				    <div class="invalid-feedback"> Bitte füllen Sie dieses Feld aus! </div>
    			  	</div>
    			  	<div class="form-group">
                    ...
                    <div class="text-right my-5">							  	
    				  	<a href="../kueche/edit_kueche.php?id=<?php echo $row['kueche']; ?>" class="btn btn-primary btn-custom">Zurück</a>
...
<script src="../../../js/administration/ansprechpartner_kueche/edit_ansprechpartner.js"></script>
