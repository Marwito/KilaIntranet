...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(!isset($_GET['aktionsgruppe'])){
            echo 'Fehler : Aktionsgruppe nicht gefunden';
        }
    }
}else {
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>Eine Aktionsgruppe einer Gruppe zuordnen</p>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="aktionsgruppe" name="aktionsgruppe" value="<?php echo $_GET['aktionsgruppe']; ?>">
    			  	<div class="form-group">
    				    <label for="input_select1">Gruppe</label>
                    ...
                    <div class="text-right my-5">							  	
    				  	<a href="../aktionsgruppe/edit_aktionsgruppe.php?id=<?php echo $_GET['aktionsgruppe']; ?>" class="btn btn-primary btn-custom">Zurück</a>
...
<script src="../../../js/administration/aktionsgruppe/add_aktionsgruppe_to_gruppe.js"></script>
