...
if($session->checkSessionVariables('username', 'usergroup')){
    ...
    if (!$benutzer->isAdmin($session->usergroup)) {
        ...
        if(!isset($_GET['kueche'])){
            echo 'Fehler : Küche nicht gefunden';
        }
    }
}else {
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="col-sm-11 offset-sm-1" style="padding-top:70px; padding-bottom:70px;">
					...
					<p>eine Einrichtung mit einer Küche zuordnen</p>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
        	<div class="col-sm-10 offset-sm-1">
        		<form name="form" method="post" action="" class="needs-validation" novalidate>
        			<input type="hidden" id="kueche" name="kueche" value="<?php echo $_GET['kueche']; ?>">
                    ...
                    <div class="text-right my-5">							  	
    				  	<a href="../kueche/edit_kueche.php?id=<?php echo $_GET['kueche']; ?>" class="btn btn-primary btn-custom">Zurück</a>
...
<script src="../../../js/administration/einrichtung/add_einrichtung_to_kueche.js"></script>
