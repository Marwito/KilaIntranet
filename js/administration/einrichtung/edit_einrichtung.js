...
$(function(){
	...
	document.getElementById("value").innerHTML = $('#input_text5').val();
	...
	function init_Datatable_Ansprechpartner() {
		...
		var einrichtung = $('#einrichtung').val();
		
		$.ajax({ 
			url: 'init_ansprechpartner_toEdit.php',
			method: 'post', 
			data: {einrichtung: einrichtung}, 
	...
	$("#submit").click(function(event){
		...
		if ($("form")[0].checkValidity() === false) {
			...
			$.ajax({
			   url: 'save_edit_einrichtung.php',
			   method: 'POST',
			   data: form_data,
			   success: function(data) {
				   $('form').removeClass('was-validated');
				   alert('Die Einrichtung wurde erfolgreich aktualisiert');
				   window.location.href="../einstellungen.php#einrichtung";
			   ...
			   error: function() {
				   alert('Bei der Aktualisierung der Einrichtung ist ein Fehler aufgetreten !');
	           }
	         });
		}
    });
