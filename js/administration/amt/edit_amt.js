...
$(function() {
	...
	$("#submit").click(function(event){
		...
		if ($("form")[0].checkValidity() === false) {
			...
			$.ajax({
			   url: 'save_edit_amt.php',
			   method: 'POST',
			   data: form_data,
			   success: function(data) {
				   $('form').removeClass('was-validated');
				   alert('Das Amt wurde erfolgreich aktualisiert');
				   window.location.href="../einstellungen.php#amt";
			   ...
			   error: function() {
				   alert('Bei der Aktualisierung des Amtes ist ein Fehler aufgetreten !');
	           }
	         });
		}
    });
